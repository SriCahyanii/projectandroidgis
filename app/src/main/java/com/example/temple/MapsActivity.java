...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama,odalan,keterangan,gambar,id;
    int jumData;
    ...
    private void getlokasi(){
        String url="https://gistemplelocation.000webhostapp.com/temple.php";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < jumData; i++) {
                            try {
                                ...
                                odalan[i] = data.getString("odalan");
                                ...
                                mMap.addMarker(new MarkerOptions()
                                        .position(latLng[i])
                                        .snippet(odalan[i])
                                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.loggo))
                                        .title(nama[i]));
                                ...
                                for(int i=0; i<jumData;i++){
                                    if(marker.getTitle().equals(nama[i])){
                                        if(MarkerD[i]) {
                                            ...
                                            DetailActivity.odalan = odalan[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "Silahkan klik sekali lagi untuk melihat detail", Toast.LENGTH_LONG);
